...
class _HomeScreenState extends State<HomeScreen> {
          ...
          builder:
            ...
            if (snapshot2.hasData) {
              ...
              if (snapshot2.data!.docs.isNotEmpty) {
                ...
                //
                strTotalPriceIs =
                    saveSnapshotValue2.first['total_count'].toString();
                //
              } else {
                if (kDebugMode) {
                  print('============================');
  ...
  funcCreateHistorySheetAlso() {
    ...
    users
        ...
        .then((value) => {
              // print(value.id),
              funcEditFirestoreIdInRegistration2(value.id),
            })
        .catchError((error) => {
  ...
  //
  funcEditFirestoreIdInRegistration2(elementId) {
    FirebaseFirestore.instance
        .collection(
            '${strFirebaseMode}history_sheet/${DateFormat('MMMM').format(DateTime.now())}/${FirebaseAuth.instance.currentUser!.uid}')
        .doc(elementId)
